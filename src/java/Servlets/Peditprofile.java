...
/********************************************************************
 *	Java III - Edit Patient Profile Servlet
 *      Kimora Bailey - Spring 2022
 *      Peditprofile.java
 ********************************************************************/
@WebServlet(name = "Peditprofile", urlPatterns = {"/Peditprofile"})
 ...
 ********************************************************************/ 
        ...
        Ppass = Integer.parseInt(request.getParameter("patpass"));
        Pfn = request.getParameter("pfn");
        Pln = request.getParameter("pln");
        Paddr = request.getParameter("padd");
        Pem = request.getParameter("pem");
        PinsCo = request.getParameter("pins");
 /********************************************************************
